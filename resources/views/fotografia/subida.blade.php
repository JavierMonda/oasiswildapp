...
<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <div class="sidebar-heading">
		...
		<!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="{{ url('/admin/fotografia')}}">
        ...
        <div class="container-fluid">
          ...
          <div class="container text-center my-auto">
            ...
            {{ csrf_field() }}
                ...
                <?php $codigo = substr(md5(time()), 0, 9);?>
					    	<input type="text" required name="codigo" value="{{$codigo}}"/>
					    </label>
				    </div>
            <div class="form-group">
              <label for="archivo">Fotos</label>
              <input type="file" name="archivo" id="archivo" class="form-control" placeholder="Subir archivos">
            </div>
